-- G:\SteamLibrary\steamapps\common\Sid Meier's Civilization VI\Base\Assets\UI\Screens\TechTree.lua
...
-- DB
					data[DATA_FIELD_PLAYERINFO].Stats[playerID][item.Type] = { Researched = true }
-- /DB
...
-- G:\SteamLibrary\steamapps\common\Sid Meier's Civilization VI\DLC\Expansion2\UI\Replacements\TechTree_Expansion1.lua
...
-- G:\SteamLibrary\steamapps\common\Sid Meier's Civilization VI\DLC\Expansion2\UI\Replacements\TechTree_Expansion2.lua
